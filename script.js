const questions = {
    ...
    Integration2: [
        {
            question: "Hartley's Law:"
            , options: [
                "a. it states that information capacity is directly propotional to bandwidth and transmission time of the system",
                "b. it states that information capacity is a function of a bandwidth and signal-to-noise ratio of the system",
                "c. it states that information capacity is proportional to the bandwidth of the system and the number of possible states per symbol",
                "d. any of these"]
            , correct: "a"
        },
        {
            question: "What is the purpose of companding?"
            , options: [
                "a. it is used to protect the lower frequency signals from noise",
                "b. it is used to protect the higher frequency signals from noise",
                "c. it is used to protect the higher amplitude signals from noise",
                "d. it is used to protect the lower amplitude signals from noise"]
            , correct: "d"
        },
        {
            question: "Instead of a signle bit, a QPSK symbol contains:"
            , options: [
                "a. a byte",
                "b. 4 bits",
                "c. a dibit",
        ...
        {
            question: "In FSK, which frequency is less in value?"
            , options: [
                "a. mark frequency",
                "b. space frequency",
                "c. either mark or space frequency",
                "d. mark and space frequency are equal "]
            , correct: "c"
        },
        {
            question: "What is the solution for slope overload in Delta Modulation PCM?"
            , options: [
                "a. increase the step-size",
                "b. decrease the step-size",
                "c. increase the input signal",
                "d. decrease the input signal"]
            , correct: "a"
        },
        {
            question: "For QAM, a constellation diagram shows:"
            , options: [
        ...
        {
            question: "What is the unit of bandwidth efficiency?"
            , options: [
                "a. bits per second",
                "b. bits per cycle",
                "c. bps per cycle",
        ...
        {
            question: "Pulse code modulation is preferred to PAM because of its:"
            , options: [
        ...
        {
            question: "For QAM, the two dimensions of its symbol space are:"
            , options: [
        ...
        {
            question: "Which of the following uses input bits called quadbit?"
            , options: [
                "a. BPSK",
                "b. QPSK",
                "c. 8PSK",
        ...
        {
            question: "The number of amplitude, freqeuncy, or phase changes that take place per second is know as the:"
            , options: [
        ...
        {
            question: "What is the solution for granular noise in Delta Modulation PCM?"
            , options: [
                "a. increase the step-size",
                "b. decrease the step size",
                "c. increase the input signal",
        ...
        {
            question: "When calculating the maximum number of users, a limiting factor in FDM is:"
            , options: [
        ...
        {
            question: "As the bit rate of an FSK signal decreases, the bandwidth:"
            , options: [
                "a. decreases",
                "b. increases",
                "c. remains the same",
        ...
        {
            question: "A linear sign-magnitude PCM code consists of:"
            , options: [
                "a. all magnitude bits",
                "b. a sign bit and magnitude bits",
                "c. two sign bits and magnitude bits",
                "d. a sign bit and a magnitude bit"]
            , correct: "b"
        },
        {
            question: "For FSK, as the difference between the two carrier frequencies increases, the bandwidth:"
            , options: [
                "a. decreases",
                "b. increases",
                "c. remains the same",
        ...
        {
            question: "Which of the following is equivalent to baud?"
            , options: [
                "a. bits per second",
                "b. samples per second",
                "c. symbols per second",
                "d. all of these"]
            , correct: "c"
        },

        {
            question: "Which of the following is not a typical FDM application?"
            , options: [
                "a. telemetry",
        ...
        {
            question: "In order to reduce quantization error, the number of quantization levels must be:"
            , options: [
                "a. increased",
                "b. decreased",
                "c. increased by 50%",
        ...
        {
            question: "In trellis coding the number of data bits is _____ the number of transmitted bits."
            , options: [
                "a. equal to",
                "b. less than",
                "c. more than",
        ...
        {
            question: "Framing bits in DS-1 are used to:"
            , options: [
                "a. detect errors",
                "b. carry signaling",
        ...
        {
            question: "In digital radio:"
            , options: [
                "a. digitally modulated analog carriers are transmitted between two or more points in a communication system",
                "b. digital carrier is modulated by a digital signal",
                "c. purely pulses are transmitted",
                "d. digital pulses are transmitted between two or more points in a communication system"]
            , correct: "a"
        },

        {
            question: "The circuit that performs demultiplexing in an FDM system is a(n):"
            , options: [
                "a. op amp",
                "b. bandpass filter",
                "c. discriminator",
        ...
        {
            question: "In Delta Modulation PCM, granular noise occurs when:"
            , options: [
                "a. the input does not change",
                "b. the input changes very fast",
                "c. the amplitude of the sampled signal changes during the sample pulse time",
                "d. the magnitude of the sample exceeds the highest quantization interval"]
            , correct: "a"
        },

        {
            question: "What is the object of trellis coding?"
            , options: [
        ...
        {
            question: "If the number of possible states per symbol is increased, the information capacity:"
            , options: [
                "a. increases",
                "b. decreases",
                "c. increases by 50%",
        ...
        {
            question: "Most FDM telemetry systems use:"
            , options: [
                "a. AM",
                "b. FM",
                "c. SSB",
        ...
        {
            question: "The biggest disadvantage of PCM is:"
            , options: [
        ...
        {
            question: "The bit rate always equals the baud rate in which type of signal?"
            , options: [
                "a. FSK",
                "b. QAM",
                "c. 4-PSK",
        ...
        {
            question: "To accurately reproduce a modulating signal in a pulse-modulated system, what minimum number of samples must be taken per cycle?"
            , options: [
                "a. one",
                "b. two",
                "c. three",
        ...
        {
            question: "Shannon-Hartley Theorem:"
            , options: [
                "a. it states that information capacity is directly proportional to bandwidth and transmission time of the system",
                "b. it states that information capacity is a function of bandwidth and signal-to-noise ratio of the system",
                "c. it states that information capacity is proportional to the bandwidth of the system and the number of possible states per symbol",
                "d. any of these"]
            , correct: "c"
        },
        {
            question: "The best frequency demodulator is the:"
            , options: [
                "a. PLL discriminator",
        ...
        {
            question: "In digital transmission, foldover distortion is produced when:"
            , options: [
                "a. the amplitude of the sampled signal changes during the sample pulse time",
                "b. Nyquist criterion is not met",
                "c. rounding off values",
                "d. the magnitude of the sample exceeds the highest quantization interval"]
            , correct: "b"
        },

        {
            question: "A modulator converts a(n) _____ signal to a(n) _____ signal."
            , options: [
                "a. digital; analog",
                "b. analog; digital",
                "c. PSK; FSK",
        ...
        {
            question: "In digital transmission, signal degradation can be removed using:"
            , options: [
                "a. an amplifier",
                "b. a filter",
        ...
        {
            question: "In TDM, for n signal sources of the same data rate, each frame contains _____ slots."
            , options: [
                "a. n",
                "b. n+1",
                "c. n-1",
        ...
        {
            question: "Natural sampling does not use:"
            , options: [
        ...
        {
            question: "In digital communications, clock recovery means:"
            , options: [
                "a. the process of extracting a phase-coherent reference carrier from a receiver signal",
                "b. the regeneration of clocks at the receiver that are synchronous with those at the transmitter",
                "c. the process of extracting a phase-coherent reference clock from a receiver signal",
                "d. the regeneration of carrier at the receiver that are synchronous with those at the transmitter"]
            , correct: "b"
        },
        {
            question: "In PAM demultiplexing, the receiver clock is derived from:"
            , options: [
        ...
        {
            question: "In digital transmission, quantization noise is produced when:"
            , options: [
                "a. the amplitude of the sampled signal changes during the sample pulse time",
                "b. Nyquist criterion is not met",
                "c. rounding off values",
        ...
        {
            question: "In TDM, the transmission rate of the multiplexed path is usually ____ the sum of the transmission rate of the signal sources:"
            , options: [
                "a. greater than",
                "b. less than",
                "c. equal to",
        ...
        {
            question: "In DS-1, bits are 'robbed' in order to:"
            , options: [
        ...
        {
            question: "What is level-at-a-time coding?"
            , options: [
                "a. this type of coding compares the PAM signal to a ramp waveform while a binary counter is being advanced at a uniform rate",
                "b. this type of coding determines each digit of the PCM code sequentially",
                "c. are flash encoders and are more complex, however they are more suitable for high-speed applications",
                "d. analogous to a balance where known reference weights are used to determine an unknown weight"]
            , correct: "a"
        },

        {
            question: "In AT&T's FDM hierarchy, the bandwidth of each group type can be found by multiplying ____ and adding extra bandwidth for guard bands:"
            , options: [
                "a. the number of voice channels by 4000 Hz",
        ...
        {
            question: "'Bit-stuffing' is more formally called:"
            , options: [
                "a. compensation",
                "b. rectification",
                "c. justification",
        ...
        {
            question: "In PSK, as the level (M) decreases, the signal's spacing:"
            , options: [
                "a. increases",
                "b. decreases",
                "c. increases by 50%",
        ...
        {
            question: "DS-1 through DS-4 are _____ while T-1 through T-4 _____."
            , options: [
        ...
        {
            question: "In the equation C = 2Blog₂M, M is the:"
            , options: [
                "a. margin of noise",
                "b. modulation index",
        ...
        {
            question: "Which of the following best describe the term bit rate?"
            , options: [
                "a. it is a theoretical expectation of the bit error rate of the given system",
                "b. it is determined before transmission",
                "c. an empirical record of a system's actual error performance",
                "d. all of these"]
            , correct: "c"
        },

        {
            question: "A quantizer is a(n):"
            , options: [
                "a. multiplexer",
                "b. demultiplexer",
                "c. A/D converter",
        ...
        {
            question: "An 'eye pattern' shows a good channel when:"
            , options: [
        ...
        {
            question: "Emphasizing low-level signals and compressing higher-level signals is called:"
            , options: [
                "a. quantizing",
                "b. companding",
                "c. pre-emphasis",
        ...
        {
            question: "Guard bands increase the bandwidth for:"
            , options: [
                "a. FDM",
                "b. TDM",
                "c. both A and B",
        ...
        {
            question: "What you see in an eye pattern is the effect of:"
            , options: [
        ...
        {
            question: "Which of the following is not a benefit of companding?"
            , options: [
                "a. minimizes noise",
        ...
        {
            question: "In Delta Modulation PCM, slope overload occurs when:"
            , options: [
                "a. the input does not change",
                "b. the input changes very fast",
                "c. the amplitude of the sampled signal changes during the sample pulse time",
        ...
        {
            question: "High-frequency radioteletype systems commonly use:"
            , options: [
                "a. FSK",
                "b. AFSK",
                "c. PSK",
        ...
        {
            question: "Formant vocoder is a vocoding technique in which:"
            , options: [
                "a. conventional speech waveforms are compressed into an analog signal with a total bandwidth of approximately 300 Hz",
                "b. the spectral power of most speech energy concentrates at three to four peak frequencies",
                "c. the most significant portions of speech information are extracted directly from the time waveform rather than from the frequency spectrum",
                "d. all of these"]
            , correct: "b"
        },

        {
            question: "What is the simplest form of pulse modulation?"
            , options: [
        ...
        {
            question: "A carrier recovery circuit is not needed with:"
            , options: [
                "a. BPSK",
                "b. QPSK",
                "c. DPSK",
        ...
        {
            question: "Part of the PCM system that prevents aliasing:"
            , options: [
                "a. bandpass filter",
                "b. anti-aperture distortion",
        ...
        {
            question: "Which is true about aliasing and foldover distortion?"
            , options: [
                "a. they are two types of sampling error",
                "b. you can have one or the other, but not both",
                "c. aliasing is a techniques to prevent foldover distortion",
                "d. they are the same thing"]
            , correct: "d"
        },
        {
            question: "The basic modulator and demodulator circuits in PSK are:"
            , options: [
                "a. PLLs",
        ...
        {
            question: "In digital transmission, peak limiting is produced when:"
            , options: [
                "a. the amplitude of the sampled signal changes during the sample pulse time",
                "b. Nyquist criterion is not met",
                "c. rounding off values",
        ...
        {
            question: "In digital communications, FSK:"
            , options: [
                "a. has poorer error performance than PSK or QAM",
                "b. poorer error performance than PSK or QAM",
                "c. is seldom used for high performance digital radio system",
                "d. all of the above"]
            , correct: "d"
        },

        {
            question: "The carrier used with a BPSK demodulator is:"
            , options: [
        ...
        {
            question: "Quantizing noise (quantization noise):"
            , options: [
        ...
        {
            question: "Which of the following uses input bits called tribit?"
            , options: [
                "a. BPSK",
                "b. QPSK",
                "c. 8PSK",
        ...
        {
            question: "The same pulse characteristic is varied in which of the following types of pulse modulations?"
            , options: [
                "a. PAM and PDM",
                "b. PDM and PWM",
                "c. PWM and PPM",
        ...
        {
            question: "Linear predictive coder is a vocoding technique in which:"
            , options: [
                "a. conventional speech waveforms are compressed into an analog signal with a total bandwidth of approximately 300 Hz",
                "b. the spectral power of most speech energy concentrates at three to four peak frequencies",
                "c. the most significant portions of speech information are extracted directly from the time waveform rather than from the frequency spectrum",
        ...
        {
            question: "The bit-rate of a DS-1 signal over a T-1 line is:"
            , options: [
                "a. 64 kbps",
                "b. 256 kbps",
                "c. 1.536 Mbps",
        ...
        {
            question: "In digital communications, squaring loop:"
            , options: [
                "a. is a common method of achieving carrier recovery for BPSK",
                "b. uses ordinary PLL in place of the BPF",
                "c. produces a loop error voltage that is proportional to twice the phase error between the incoming signal and the VCO signal",
                "d. has a faster acquisition time"]
            , correct: "a"
        },

        {
            question: "A QAM modulator does not use a(n):"
            , options: [
                "a. XNOR",
                "b. bit splitter",
        ...
        {
            question: "What is digit-at-a-time coding?"
            , options: [
                "a. this type of coding compares the PAM signal to a ramp waveform while a binary counter is being advanced at a uniform rate",
                "b. generally limited to low-speed applications",
                "c. are flash encoders and are more complex, however they are more suitable for high-speed applications",
                "d. analogous to a balance where known reference weights are used to determine an unknown weight"]
            , correct: "d"
        },
        ...
        {
            question: "Besides data bits, a DS-1 frame contains a:"
            , options: [
                "a. timing bit",
                "b. T-bit",
                "c. signaling bit",
        ...
        {
            question: "In DPSK, if the output has no phase shift, then the inputs:"
            , options: [
                "a. there is no input signal",
                "b. have different level",
                "c. are shifted by 180 degrees",
                "d. have same level"]
            , correct: "d"
        },

        {
            question: "In DS-1, a bit is 'stolen' out of each channel:"
            , options: [
                "a. every frame",
                "b. every other frame",
                "c. every sixth frame",
                "d. every tweltfth frame"]
            , correct: "c"
        },
        {
        ...
        {
            question: "A supergroup contains how many voice channels?"
            , options: [
                "a. 60",
                "b. 40",
                "c. 30",
        ...
        {
            question: "The dynamic range of a system is the ratio of:"
            , options: [
...

        {
            question: "In OQPSK:"
            , options: [
                "a. the bit waveforms on the I and Q channel are offset or shifted in phase from each other by one-third of a bit time",
                "b. the bit waveforms on the I and Q channel are offset or shifted in phase from each other by one-half of a bit time",
                "c. the bit waveforms on the I and Q channel are offset or shifted in phase from each other by one-fourth of a bit time",
                "d. the bit waveforms on the I and Q channel are offset or shifted in phase from each other by twice of a bit time"]
            , correct: "b"
        },

        {
            question: "Using the Shannon formula to calculate the data rate for a given channel, if C = B, then:"
            , options: [
        ...
        {
            question: "In digital communications, carrier recovery means:"
            , options: [
                "a. the process of extracting a phase-coherent reference carrier from a receiver signal",
                "b. the regeneration of clocks at the receiver that are synchronous with those at the transmitter",
                "c. the process of extracting a phase-coherent reference clock from a receiver signal",
                "d. the regenerationof carrier at the receiver that are synchronous with those at the transmitter"
            ]
            , correct: "a"
        },
        {
            question: "Unipolar, bipolar and polar encoding are types of _____ encoding"
            , options: [
                "a. line",
                "b. block",
                "c. NRZ",
        ...
        {
            question: "A T5 carrier contains how many voice channels?"
            , options: [
                "a. 8064",
                "b. 4032",
                "c. 8604",
        ...
        {
            question: "In PSK, if the signal’s spacing is decreased further, it can cause:"
            , options: [
                "a. noise",
                "b. attenuation",
                "c. absorption",
        ...
        {
            question: "Pulse rate is always _____ the bit rate."
            , options: [
                "a. greater than",
                "b. less than",
        ...
        {
            question: "_____ encoding has a transition at the middle of each bit."
            , options: [
                "a. RZ",
                "b. Manchester",
        ...
        {
            question: "Compared to PCM, delta modulation:"
            , options: [
        ...
        {
            question: "DPSK uses _____ gate as its primary circuit."
            , options: [
                "a. AND",
                "b. OR",
                "c. XNOR",
        ...
        {
            question: "_____ encoding has a transition at the beginning of each 0 bit."
            , options: [
                "a. RZ",
                "b. Manchester",
                "c. differential Manchester",
        ...
        {
            question: "A vocoder implements compression by:"
            , options: [
        ...
        {
            question: "It is the distance between symbols on the constellation diagram:"
            , options: [
                "a. Laplacian distance",
        ...
        {
            question: "PCM is an example of ________ conversion:"
            , options: [
        ...
        {
            question: "Compared to standard PCM systems, the quality of the output of a vocoder is:"
            , options: [
                "a. much better",
                "b. somewhat better",
                "c. about the same",
        ...
        {
            question: "In digital communications, remodulator:"
            , options: [
                "a. is a common method of achieving carrier recovery for BPSK",
                "b. uses ordinary PLL in place of the BPF",
                "c. the received BPSK waveform is filtered and squared",
                "d. has a faster acquisition time"]
            , correct: "d"
        },

        {
            question: "The Nyquist theorem specifies the minimum sampling rate to be:"
            , options: [
        ...
        {
            question: "As the peak frequency deviation of an FSK signal decreases, the bandwidth:"
            , options: [
                "a. decreases",
                "b. increases",
                "c. remains the same",
        ...
        {
            question: "One factor in the accuracy of a reconstructed PCM signal is the:"
            , options: [
                "a. signal bandwidth",
                "b. carrier frequency",
        ...
        {
            question: "For FSK, as the difference between the two carrier frequencies decreases, the bandwidth:"
            , options: [
                "a. decreases",
                "b. increases",
                "c. remains the same",
        ...
        {
            question: "Which encoding type always has nonzero average amplitude:"
            , options: [
                "a. unipolar",
                "b. polar",
                "c. bipolar",
        ...
        {
            question: "In telephone system FDM, voice is put on a carrier using:"
            , options: [
                "a. SSB",
                "b. DSBSC",
                "c. PDM",
        ...
        {
            question: "Foldover distortion is caused by:"
            , options: [
                "a. noise",
        ...
        {
            question: "In digital communications, Costas loop:"
            , options: [
                "a. is a common method of achieving carrier recovery for BPSK",
                "b. uses ordinary PLL in place of the BPF",
                "c. produces a loop error voltage that is proportional to twice the phase error between the incoming signal and the VCO signal",
        ...
        {
            question: "The process of arbitrarily dividing a wave into a series of standard values is referred to as:"
            , options: [
                "a. arbitration",
                "b. quantization",
                "c. interposition",
        ...
        {
            question: "Which of the following best describe the term probability of error?"
            , options: [
                "a. it is a theoretical expectation of the bit error rate of the given system",
                "b. it is determined after the transmission is done",
                "c. an empirical record of a system's actual error performance",
                "d. all of these"]
            , correct: "a"
        },
        ...
        {
            question: "The immediate result of sampling is:"
            , options: [
                "a. a sample alias",
                "b. PAM",
                "c. PCM",
        ...
        {
            question: "RZ encoding involves _____ signal levels."
            , options: [
                "a. two",
                "b. three",
                "c. four",
        ...
        {
            question: "The number of bits per sample in DS-1 is:"
            , options: [
                "a. 1",
                "b. 2",
                "c. 4",
        ...
        {
            question: "In PSK, as the level (M) decreases, the transmission time:"
            , options: [
                "a. increases",
                "b. decreases",
                "c. increase by 50%",
        ...
        {
            question: "The number of samples per second in DS-1 is:"
            , options: [
                "a. 8 k",
                "b. 56 k",
                "c. 64 k",
        ...
        {
            question: "For every one cycle there must be at least ____ samples."
            , options: [
                "a. one",
                "b. two",
                "c. three",
        ...
        {
            question: "ASK, PSK, FSK and QAM are examples of ____ modulation."
            , options: [
                "a. digital-to-analog",
                "b. digital-to-analog",
                "c. analog-to-analog",
        ...
        {
            question: "The bit rate for each channel in DS-1 is:"
            , options: [
                "a. 1.544 Mb/s",
                "b. 64 kb/s",
                "c. 56 kb/s",
        ...
        {
            question: "Which of the following is most affected by noise?"
            , options: [
                "a. PSK",
                "b. ASK",
                "c. FSK",
        ...
        {
            question: "In digital transmission, aperture error is produced when:"
            , options: [
                "a. the amplitude of the sampled signal changes during the sample pulse time",
                "b. Nyquist Criterion is not met",
                "c. rounding off values",
        ...
        {
            question: "In 16-QAM, there are 16:"
            , options: [
        ...
        {
            question: "What is word-at-a-time coding?"
            , options: [
                "a. this type of coding compares the PAM signal to a ramp waveform while a binary is being advanced at a uniform rate",
                "b. this type of coding determines each digit of the PCM code sequentially",
                "c. are flash encoders and are more complex, however they are more suitable for high speed applications",
                "d. analogous to a balance where known reference weights are used to determine an unknown weight"]
            , correct: "c"
        ...
        {
            question: "In delta modulation, 'granular noise' is produced when:"
            , options: [
        ...
        {
            question: "Shannon’s Limit for Information Capacity:"
            , options: [
                "a. it states that information capacity is directly proportional to bandwidth and transmission time of the system",
                "b. it states that information capacity is a function of bandwidth and signal-to-noise ratio of the system",
                "c. it states that information capacity is proportional to the bandwidth of the system and the number of possible states per symbol",
        ...
        {
            question: "Multiplexing is the process of:"
            , options: [
        ...
        {
            question: "When an ASK signal is decomposed, the result is:"
            , options: [
        ...
        {
            question: "Which of the following defines the baud rate?"
            , options: [
                "a. the rate of change at the output of the modulator",
                "b. the rate of change at the input of the modulator",
                "c. the rate of change at the output of the oscillator",
                "d. the rate of change at the input of the oscillator"]
            , correct: "a"
        },

        {
            question: "The modulation used in FDM telephone systems is:"
            , options: [
                "a. AM",
                "b. FM",
                "c. SSB",
        ...
        {
            question: "A linear PCM code consists of:"
            , options: [
                "a. all magnitude bits",
                "b. a sign bit and magnitude bits",
                "c. two sign bits and magnitude bits",
        ...
        {
            question: "If the transmission time is decreased, the information capacity:"
            , options: [
                "a. increases",
                "b. decreases",
                "c. increases by 50%",
        ...
        {
            question: "The FDM telephone systems accommodate many channels by:"
            , options: [
        ...
        {
            question: "In digital transmission, ISI:"
            , options: [
                "a. it is an important consideration in the transmission of pulses over circuits with a wider bandwidth and a nonlinear response",
                "b. it is an important consideration in the transmission of analog signals over circuits with a limited bandwidth and a nonlinear response",
                "c. it is an important consideration in the transmission of pulses over circuits with a limited bandwidth and a nonlinear response",
                "d. it is an important consideration in the transmission of analog signals over circuits with a wider bandwidth and a nonlinear response"]
            , correct: "c"
        },
        ...
        {
            question: "If the signal-to-noise ratio is increased, the information capacity:"
            , options: [
                "a. increases",
                "b. decreases",
                "c. increases by 50%",
        ...
        {
            question: "In TDM, multiple signals:"
            , options: [
        ...
        {
            question: "Which is not a primary cause of intersymbol interference?"
            , options: [
        ...
        {
            question: "Which multiplexing technique transmits digital signals?"
            , options: [
                "a. FDM",
                "b. TDM",
                "c. WDM",
...

        {
            question: "In CP-FSK:"
            , options: [
                "a. the mark and space frequencies are synchronized with the input binary baud rate",
                "b. the mark and space frequencies are synchronized with the output binary bit rate",
                "c. the mark and space frequencies are synchronized with the input binary bit rate",
                "d. the mark and space frequencies are synchronized with the output binary baud rate"]
            , correct: "c"
        },

        {
            question: "Sampling an analog signal produces:"
            , options: [
                "a. PAM",
                "b. AM",
                "c. FM",
        ...
        {
            question: "In DPSK, if the output is shifted by 180 degrees, then the inputs:"
            , options: [
                "a. there is no input signal",
                "b. have different level",
                "c. also shifted by 180 degrees",
                "d. have same level"]
            , correct: "b"
        },

        {
            question: "Compared to PCM, adaptive delta modulation can transmit voice:"
            , options: [
        ...
        {
            question: "Which of the following defines the bit rate?"
            , options: [
                "a. the rate of change at the output of the modulator",
                "b. the rate of change at the input of the modulator",
                "c. the rate of change at the output of the oscillator",
        ...
        {
            question: "In FDM, multiple signals:"
            , options: [
        ...
        {
            question: "What is midtread quantization?"
            , options: [
                "a. a method used to reduce quantization noise",
                "b. a method used to reduce aliasing",
                "c. a method used to reduce aperture error",
                "d. a method used to reduce idle channel noise"]
            , correct: "d"
        },
        {
            question: "For a given bit rate, the minimum bandwidth for ASK is the minimum bandwidth for FSK."
            , options: [
                "a. equivalent to",
                "b. less than",
                "c. greater than",
        ...
        {
            question: "Which coding scheme requires DC continuity:"
            , options: [
                "a. AMI",
                "b. Manchester",
                "c. unipolar NRZ",
        ...
        {
            question: "In digital transmission:"
            , options: [
                "a. digitally modulated analog carriers are transmitted between two or more points in a communication system",
                "b. analog carrier is modulated by a digital signal",
                "c. purely pulses are transmitted",
                "d. the medium can be wired or wireless"]
            , correct: "c"
        },

        {
            question: "Each signal in an FDM system:"
            , options: [
        ...
        {
            question: "Channel vocoder is a vocoding technique in which:"
            , options: [
                "a. conventional speech waveforms are compressed into an analog signal with a total bandwidth of approximately 300 Hz",
                "b. the spectral power of most speech energy concentrates at three to four peak frequencies called formants",
                "c. the most significant portions of speech information are extracted directly from the time waveform rather than from the frequency spectrum",
                "d. all of these"]
            , correct: "a"
        },
        ...
        {
            question: "As the bit rate of an FSK signal increases, the bandwidth:"
            , options: [
                "a. decreases",
                "b. increases",
                "c. remains the same",
        ...
        {
            question: "Which modulation technique involves tribits, eight different phase shifts, and one amplitude?"
            , options: [
                "a. FSK",
                "b. 8-PSK",
                "c. ASK",
        ...
        {
            question: "A typical T-1 line uses:"
            , options: [
                "a. twisted-pair wire",
                "b. coaxial cable",
                "c. fiber-optic cable",
