const questions = {
    ...
    EST: [
        ...
        { question: "The term bel is a unit of measure ment that expresses which of the following relationships?", options: ["a. ratio of voltage and resistance", "b. logarithmic ratio between input and output", "c. geometric progression from input to output", "d. ratio of voltage to current"], correct: "b"},
